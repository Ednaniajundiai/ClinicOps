...
Criar projeto Next.js e configurar Supabase
Implementar schema do banco com RLS
Desenvolver autenticacao e estrutura base
8 To-dos · Completed In Order
New
Setup Next.js + Supabase + Schema com RLS
Autenticacao e estrutura de rotas protegidas
Dashboard Master e Admin Tenant
Dashboard Usuario e CRUD pacientes/atendimentos
Integracao Stripe e Landing/Pricing
Sistema de auditoria e compliance LGPD
App React Native com funcoes essenciais
Deploy Vercel e documentacao final
Referenced by 1 Agent
Plano de MVP para processo seletivo · Author
